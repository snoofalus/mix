...
#Method options
parser.add_argument('--n-labeled', type=int, default=120,
...
#python train.py --gpu 0 --n-labeled 120 --out glcm@120
def main():
    global best_acc
    ...
    # Data
    print(f'==> Preparing s1s2glcm')

    root = os.path.abspath('../data-local')
    train_labeled_set, train_unlabeled_set, val_set, test_set = dataset.get_s1s2glcm(root, args.n_labeled)
